...
def _convert_to_example(filename, image_buffer, offsets, height, width, depth, num_channels):
  ...
  example = tf.train.Example(features=tf.train.Features(feature={
      ...
      'image/offsets': _int64_feature(offsets),
      # 'targets/GHI': _int64_feature(offset),
      # 'image/station': _bytes_feature(num_channels),
