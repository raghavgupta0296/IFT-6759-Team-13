...
def init_args():
    ...
    parser.add_argument('--data_catalog_path', default=data_catalog,
                        help='catalog absolute file path (dataframe) which contains the image paths, ghi and other metadata')
    parser.add_argument('--station_data', default=STATION_INFO,
                        help='catalog absolute file path (dataframe) which contains the image paths, ghi and other metadata')
    parser.add_argument('--channels', default=CHANNELS,
                        help='catalog absolute file path (dataframe) which contains the image paths, ghi and other metadata')

    parser.add_argument('--crop_size', default=CROP_SIZE,
