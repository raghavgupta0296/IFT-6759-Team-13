...
def init_args():
	...
	parser.add_argument('--k_sequences',default=1,type=int,help='how many image sequences in the past to take')
	parser.add_argument('--img_sequence_step',default=4,type=int,help='step size for k_sequences. in offset unit terms')    
	parser.add_argument('--future_ghis',default=1,type=int,help='''how many future GHIs to predict apart from T0.
