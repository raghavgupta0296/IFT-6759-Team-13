...
from tensorflow.keras.layers import ReLU, Dense, Flatten, Conv3D, MaxPooling3D, MaxPool3D, BatchNormalization
...
class MyModel(Model):
	def __init__(self,args):
		...
		self.conv1 = Conv3D(32, kernel_size=(1,3,3), input_shape=(args.k_sequences+1,70,70,5), kernel_initializer='he_uniform')
		...
		self.d1 = Dense(args.future_ghis+1, activation='linear')
