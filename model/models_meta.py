...
class Resnet_Meta(Model):
    def __init__(self, args):
        ...
        self.resnet_base = ResNet50(
            include_top=False, weights=None, input_shape=(
                70, 70, 5), pooling='avg')
    ...
    def call(self, x):
        ...
        x2 = self.concatenation(
            [x2_1, x22_2, x2_3, x2[2][0], x2[2][1], x2[2][2], x2[2][3]])
        x2 = self.d2(x2)
...
class Basic_CNN_Meta(Model):
    ...
    def call(self, x):
        ...
        x = self.concatenation(
            [x, x2_1, x2_2, x2_3, x2[4], x2[5], x2[6], x2[7]])
